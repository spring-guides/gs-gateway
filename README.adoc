...
If you use Maven, visit the https://start.spring.io/#!type=maven-project&language=java&platformVersion=2.5.4&packaging=jar&jvmVersion=1.8&groupId=com.example&artifactId=gateway-initial&name=gateway-initial&description=Demo%20project%20for%20Spring%20Cloud%20Gateway&packageName=com.example.gateway-initial&dependencies=cloud-gateway,cloud-resilience4j,cloud-contract-stub-runner[Spring Initializr] to generate a new project with the required dependencies (Gateway, Resilience4J, and Contract Stub Runner).
...
If you use Gradle, visit the https://start.spring.io/#!type=gradle-project&language=java&platformVersion=2.5.4&packaging=jar&jvmVersion=1.8&groupId=com.example&artifactId=gateway-initial&name=gateway-initial&description=Demo%20project%20for%20Spring%20Cloud%20Gateway&packageName=com.example.gateway-initial&dependencies=cloud-gateway,cloud-resilience4j,cloud-contract-stub-runner[Spring Initializr] to generate a new project with the required dependencies (Gateway, Resilience4J, and Contract Stub Runner).
